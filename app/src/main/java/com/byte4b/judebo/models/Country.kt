...
val languages = listOf(
    ...
    Language(23, "Dutch", "--", drawable.nl, "nl", "EUR"),
    ...
    Language(29, "Czech", "--", drawable.cs, "cs", "EUR"),
    Language(30, "Swedish", "Svenska", drawable.sv, "sv", "EUR"),
    Language(31, "Bulgarian", "Български", drawable.bg, "bg", "EUR"),
    Language(32, "Hebrew", "--", drawable.he, "he", "EUR"),
    Language(33, "Serbian", "--", drawable.sr, "sr", "EUR"),
    Language(34, "Tajik", "--", drawable.tg, "tg", "EUR"),
    Language(35, "Turkmen", "--", drawable.tk, "tk", "EUR"),
    Language(36, "Belorussian", "--", drawable.be, "be", "EUR"),
    Language(37, "Croatian", "--", drawable.hr, "hr", "EUR"),
    Language(38, "Armenian", "--", drawable.hy, "hy", "EUR"),
    Language(39, "Finnish", "--", drawable.fi, "fi", "EUR"),
    Language(40, "Georgian", "ქართული", drawable.ka, "ka", "EUR"),
    Language(41, "Lithuanian", "--", drawable.lt, "lt", "EUR"),
    Language(42, "Norwegian Nynorsk", "--", drawable.nn, "nn", "EUR"),
